...
| [Google Cloud Storage](https://github.com/robinrodricks/FluentStorage/wiki/Google-Cloud-Storage#connection-strings) | <span class="badge badge--secondary">aws.s3://keyId=...;key=...;bucket=...;region=...</span>                                                                                    |
