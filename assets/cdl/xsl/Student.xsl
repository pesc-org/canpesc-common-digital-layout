...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template name="StudentInformation.DateOfBirth">
		<xsl:choose>
			<xsl:when test="//*[local-name()='Student']/*[local-name()='Person']/*[local-name()='Birth']/*[local-name()='BirthDate']/text()=''">
				<xsl:value-of select="//*[local-name()='Student']/*[local-name()='Person']/*[local-name()='Birth']/*[local-name()='Birthday']/text()"/>
			</xsl:when>
			<xsl:otherwise>
				<xsl:value-of select="//*[local-name()='Student']/*[local-name()='Person']/*[local-name()='Birth']/*[local-name()='BirthDate']/text()"/>
			</xsl:otherwise>
		</xsl:choose>
	</xsl:template>
